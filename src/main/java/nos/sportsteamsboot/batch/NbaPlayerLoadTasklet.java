...
public class NbaPlayerLoadTasklet implements Tasklet {

    private static final Logger logger = LoggerFactory.getLogger(NbaPlayerLoadTasklet.class);
    private List<Long> teamIds;

    @Autowired private TeamService teamService;
    @Autowired private NbaRestClient restClient;

    public NbaPlayerLoadTasklet(){
    }
